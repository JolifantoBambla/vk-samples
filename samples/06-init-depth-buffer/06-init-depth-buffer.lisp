...
(defun 06-init-depth-buffer (&optional (app-name "05-init-swapchain") (window-width 500) (window-height 500))
  ...
  (with-gfx (instance device physical-device surface :app-name app-name :window-width window-width :window-height window-height)
    (let* ((depth-format :d16-unorm)
           ...
           (image-create-info (make-instance 'vk:image-create-info
                                             :image-type :2d
                                             :format depth-format
             ...
             (unwind-protect
                  (progn
                    (vk:bind-image-memory device
                                          ...
                                          depth-memory
                                          0) ;; offset
                    (let* ((component-mapping (make-instance 'vk:component-mapping
                                                             :r :r
                                                             :g :g
                                                             :b :b
                                                             :a :a))
                           (subresource-range (make-instance 'vk:image-subresource-range
                                                             ...
                                                             :base-array-layer 0
                                                             :layer-count 1))
                           (image-view-create-info (make-instance 'vk:image-view-create-info
                                                                  :image depth-image
                                                                  :view-type :2d
                                                                  :format depth-format
