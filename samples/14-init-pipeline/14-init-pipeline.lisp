      ...
      (with-simple-pipeline-layout (pipeline-layout
        ...
        (with-shader-module (vertex-shader-module
          ...
          (with-shader-module (fragment-shader-module
                               device
                               "fragment-shader.spv")
            (let* ((vertex-shader-stage-create-info (vk:make-pipeline-shader-stage-create-info
                                                     :stage :vertex
                                                     :module vertex-shader-module
                                                     :name "main"))
                   (fragment-shader-stage-create-info (vk:make-pipeline-shader-stage-create-info
                                                       :stage :fragment
                   ...
                   (vertex-input-attribute-descriptions (list
                                                         ...
                                                         (vk:make-vertex-input-attribute-description
                                                          ...
                                                          :format :r32g32b32a32-sfloat
                                                          :offset 16)))
                   (pipeline-vertex-input-state-create-info (vk:make-pipeline-vertex-input-state-create-info
                   ...
                   (pipeline-input-assembly-state-create-info (vk:make-pipeline-input-assembly-state-create-info
                                                               :topology :triangle-list
                                                               :primitive-restart-enable nil))
                   (pipeline-viewport-state-create-info (vk:make-pipeline-viewport-state-create-info
                   ...
                   (pipeline-rasterization-state-create-info (vk:make-pipeline-rasterization-state-create-info
                                                              ...
                                                              :line-width 1.0))
                   (pipeline-multisample-state-create-info (vk:make-pipeline-multisample-state-create-info
                   ...
                   (stencil-op-state (vk:make-stencil-op-state
                                      ...
                                      :write-mask 0
                                      :reference 0))
                   (pipeline-depth-stencil-state-create-info (vk:make-pipeline-depth-stencil-state-create-info
                                                              :depth-test-enable t
                   ...
                   (pipeline-color-blend-attachment-state (vk:make-pipeline-color-blend-attachment-state
                                                           :blend-enable nil
                   ...
                   (pipeline-color-blend-state-create-info (vk:make-pipeline-color-blend-state-create-info
                                                            :logic-op-enable nil
                                                            :logic-op :no-op
                   ...
                   (pipeline-dynamic-state-create-info (vk:make-pipeline-dynamic-state-create-info
                                                        :dynamic-states dynamic-states))
                   (graphics-pipeline-create-info (vk:make-graphics-pipeline-create-info
